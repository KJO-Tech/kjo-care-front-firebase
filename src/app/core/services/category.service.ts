...
export class CategoryService {
  ...
  create(category: Omit<Category, 'id'>): Observable<string> {
    return from(
      addDoc(collection(this.firestore, this.collectionName), category),
    ).pipe(
  ...
  toggleStatus(id: string, currentStatus: boolean): Observable<void> {
    return this.update({ isActive: !currentStatus }, id);
  }
