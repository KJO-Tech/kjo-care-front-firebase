...
import { of } from 'rxjs';
import { CloudinaryUploadParams } from './core/interfaces/cloudinary.interface';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, ToastComponent, FormsModule, CommonModule],
  template: `
            ...
            <div class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
              ...
              <div class="card-body p-4">
                <div class="flex justify-between items-center">
                  ...
                  <button
                    (click)="deleteAsset(asset.public_id)"
...
export class AppComponent {
  ...
  deleteAsset(publicId: string): void {
    this.cloudinary.deleteAsset(publicId)
  }
